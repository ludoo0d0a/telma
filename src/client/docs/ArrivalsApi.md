...
|------------- | ------------- | -------------|
|[**coverageCoverageStopAreasIdArrivalsGet**](#coveragecoveragestopareasidarrivalsget) | **GET** /coverage/{coverage}/stop_areas/{id}/arrivals | Get next arrivals to a stop area|

# **coverageCoverageStopAreasIdArrivalsGet**
> ArrivalsResponse coverageCoverageStopAreasIdArrivalsGet()
...
const apiInstance = new ArrivalsApi(configuration);
...
const { status, data } = await apiInstance.coverageCoverageStopAreasIdArrivalsGet(
    coverage,
    id,
    datetime,
    count,
...
|-------------|-------------|------------------|
|**200** | List of arrivals |  -  |
|**404** | Stop area not found or no arrivals |  -  |
