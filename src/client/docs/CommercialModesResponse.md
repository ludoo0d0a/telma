...
------------ | ------------- | ------------- | -------------
**commercial_modes** | [**Array&lt;CommercialMode&gt;**](CommercialMode.md) |  | [optional] [default to undefined]
...
```typescript
import { CommercialModesResponse } from './api';

const instance: CommercialModesResponse = {
    commercial_modes,
    pagination,
    feed_publishers,
    disruptions,
