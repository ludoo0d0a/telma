      ...
      <div class="container">
            ...
            <div class="columns">
              <div class="column is-half">
                <p>
                  ...
                  <span class="tag is-primary is-medium">{{ packageJson.version }}</span>
                </p>
                <p class="mt-3">
        ...
        <div class="box mb-5">
          ...
          <div class="columns is-multiline">
            <div
              v-for="(feature, index) in functionalFeatures"
              :key="index"
        ...
        <div class="box mb-5">
          ...
          <div class="columns is-multiline">
            <div
              v-for="(feature, index) in technicalFeatures"
              :key="index"
              class="column is-half-tablet is-full-mobile"
            >
              <div class="media">
...
const technicalFeatures: Feature[] = [
  ...
  },
  {
    ...
    description: 'Swagger UI Vue for interactive API exploration',
    icon: BookOpen,
  },
  {
    title: 'Maps',
    description: 'MapLibre GL and Vue Map GL for interactive maps',
    icon: Map,
  },
  {
    title: 'Build Tool',
  ...
  {
    title: 'Testing',
    description: 'Vitest with Vue Testing Library',
    icon: FlaskConical,
  },
];
