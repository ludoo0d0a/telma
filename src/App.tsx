...
const AppContent: React.FC = () => {
    ...
    const useMobileView = location.pathname === '/sample1' || location.pathname === '/sample2' || location.pathname === '/sample3' || location.pathname === '/itinerary' || location.pathname.startsWith('/itinerary/');
