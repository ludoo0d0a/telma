  ...
  <header class="skytrip-page-header">
    <div class="header-top">
      <div class="left-actions">
        <button v-if="resolvedLeftAction === 'back'" @click="handleBack" class="icon-button back-button">
          <ArrowLeft :size="20" :stroke-width="2" />
        </button>
        <button v-else @click="handleMenu" class="icon-button menu-button">
      ...
      <div class="right-actions">
        <button v-if="showSearch" class="icon-button search-button" @click="onSearch">
